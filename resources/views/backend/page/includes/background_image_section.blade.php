        ...
        <div class="card ctm-border-radius shadow-sm flex-fill">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-1 mt-2">
                            <label class="form-label required"> Description <span class="text-danger">* write 1400 characters only</span></label>
                            <textarea class="form-control" maxlength="1400" rows="14" name="description" id="basic_editor" required>{!! $basic_image_section->description ?? null !!}</textarea>
                            <div class="invalid-feedback">
